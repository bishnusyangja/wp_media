# Generated by Django 2.2.4 on 2019-08-14 02:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_on', models.DateTimeField(auto_now=True, verbose_name='Modified Date')),
        ...
        migrations.AddField(
            model_name='customer',
            name='subscription',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='panel.Plan'),
        ),
        migrations.AddField(
            model_name='customer',
            name='user',
